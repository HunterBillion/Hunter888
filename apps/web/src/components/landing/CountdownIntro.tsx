  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage: `radial-gradient(circle, var(--grid-dot-color, var(--accent-glow)) 1px, transparent 1px)`,
      ...
      <motion.div
        ...
        style={{
          background: "radial-gradient(ellipse at 50% 50%, var(--accent-muted) 0%, transparent 60%)",
        }}
      />
