        ...
        {hangupWarning && (
          ...
          >
            <div className="flex items-center gap-3">
              <div className="flex-shrink-0 w-8 h-8 rounded-full flex items-center justify-center" style={{ background: "var(--danger-muted)" }}>
      ...
      <AnimatePresence>
        {objectionHint && (
          ...
          >
            ...
            >
              <div className="flex items-center justify-center w-8 h-8 rounded-lg shrink-0" style={{ background: "var(--accent-glow)" }}>
            ...
            <motion.div
              ...
              style={{ background: "rgba(107,77,199,0.4)" }}
              initial={{ width: "100%" }}
              animate={{ width: "0%" }}
