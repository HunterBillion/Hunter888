...
/**
 * ClientDomainPanel — TZ-1 operations center.
 * Mounted from /admin/client-domain (thin re-export) and /dashboard
 * tab "Система" sub-tab "Client Domain". Caller handles admin gate.
 *
...
export function ClientDomainPanel() {
