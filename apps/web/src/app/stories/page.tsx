...
export default function GameCRMPage() {
  ...
  return (
    <AuthLayout>
      <div className="min-h-[calc(100vh-64px)] bg-[radial-gradient(circle_at_top,rgba(107,77,199,0.14),transparent_32%),linear-gradient(180deg,#040405_0%,#0a0a0d_45%,#09090b_100%)]">
        {/* Header */}
        <motion.div
              ...
              <div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
                <div className="max-w-2xl">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex h-11 w-11 items-center justify-center rounded-2xl" style={{ background: "var(--accent-muted)", border: "1px solid var(--accent-glow)" }}>
