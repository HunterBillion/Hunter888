                ...
                <div className="flex items-center justify-center gap-6 mt-5">
                  {[
                    ...
                    <div key={place} className="text-center">
                      <div className={`text-xl ${place === 1 ? "neon-pulse" : ""}`}>{emoji}</div>
                    ...
                    {leaderboard.map((entry, i) => (
                      ...
                      >
                        <span className="w-8 text-center font-mono text-sm font-bold" style={{ color: "var(--text-muted)" }}>
                          {entry.is_podium ? PODIUM_EMOJI[entry.rank - 1] : `#${entry.rank}`}
                        </span>
...
function PodiumSlot({
  ...
  return (
    <div className="flex flex-col items-center w-24">
      ...
      <div className={`text-xl mb-1 ${place === 1 ? "neon-pulse" : ""}`}>{PODIUM_EMOJI[place - 1]}</div>
      <div
