...
KEYWORD_PATTERNS: dict[str, list[str]] = {
    # 2026-04-20: expanded after owner audit — real dialogues stalled at
    # "cold" because the engine received zero triggers even when the manager
    # clearly acknowledged the client's concern. All matching is substring +
    # lowercase, so roots cover inflected forms ("понятн" catches
    # "понятен"/"понятна"/"понятно").
    "empathy": [
        "понимаю",
        "понятн",           # понятен / понятна / понятно / понятный
        "сочувствую",
        "на вашем месте",
        "это тяжело",
        "вам непросто",
    ...
    "facts": [
        "по закону",
        "законн",           # законный / законно / законным
        "законодательств",
        "статья",
        "127-фз",
        "127 фз",
        ...
        "федеральный закон",
        "нормативно",
        "арбитражн",        # арбитражный управляющий / арбитраж
        "суд назначает",
        "официальн",        # официальная компания / официально
        "реквизит",
    ],
    "pressure": [
        "только сегодня",
    ...
    # Phase F1 (2026-04-20): expanded 6 → 60+ to catch realistic
    # sales-floor rudeness. Owner feedback: manager послал клиента (на
    # мат), но detection пропустил — список был только из «мягких»
    # школьных обзывательств. Покрываем прямые оскорбления, презрение,
    ...
    "flexible_offer": [
        "рассрочка",
        "в рассрочку",
        "частями",          # платить частями
        "скидка",
        "бонус",
        "гибкие условия",
        "разбить на части",
        "бесплатн",         # бесплатная консультация / бесплатно
        "без предоплат",
        "онлайн",           # онлайн-консультация
        "из дома",
        "никуда ехать не",
        "на ваш выбор",
    ],
    "resolve_fear": [
        ...
        "не потеряете",
        "никаких подписей",
        "ни к чему не обязыва",
        "вы не обязан",
        "можете отказаться",
        "без давления",
        "не мой стиль",
        "суд назначает управляющ",
        "управляющего назначает суд",
        "гарантирован",     # гарантированно / гарантии
        "по шагам",
        "шаг за шагом",
    ],
    "counter_aggression": [
